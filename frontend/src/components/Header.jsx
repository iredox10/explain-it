    ...
    <div className="relative bg-primary-color min-h-[12rem] w-full shadow-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="mt-12 text-center text-white">
          ...
          <p className="text-lg md:text-xl text-gray-100 capitalize">{subtitle}</p>
        </div>
        ...
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2">
          <div className="relative">
            ...
            />
            <svg className="w-5 h-5 absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
